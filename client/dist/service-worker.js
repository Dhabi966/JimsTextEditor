  ...
  (s.n = (e) => {
    ...
    (() => {
      ...
      (0, s(796).precacheAndRoute)([
        { revision: "356d5e88a6f98dbc05de6fb781bfbf7f", url: "index.html" },
        {
          revision: "527a11dd51b82b2f7b99fbf54f7c0dc2",
        ...
        { revision: "da3d428831ddbc3ea04d532527f7e1d2", url: "main.bundle.js" },
        {
          revision: "4e0e34f265fae8f33b01b27ae29d9d6f",
      ...
      t({ urls: ["/index.html", "/"], strategy: c }),
        ...
        n(function (e) {
          var t = e.request;
          return ["string", "script", "worker"].includes(
            "image" === t.destination
          );
        }, new a({
          ...
          plugins: [
            new r({ statuses: [0.2] }),
            new i({ maxEntries: 60, maxAgeSeconds: 3888e3 }),
          ],
        }));
    })();
})();
